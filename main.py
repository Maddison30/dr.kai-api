...
"CITATION FORMAT: Use simple numbered references in the format [1], [2], [3], etc. "
"Place the reference number directly after the relevant information in the text. "
"Provide the actual URLs as a numbered list at the end of your response. "
"Example: 'Frozen shoulder causes pain and stiffness [1]. Treatment options include physical therapy [2].' "
"Then at the end list: '[1] https://example.com/frozen-shoulder [2] https://example.com/treatment'\n\n"
"LANGUAGE HANDLING: "
...
"Then provide numbered URL list at the very end.\n\n"
